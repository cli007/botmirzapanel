...
if ($text == $datatextbot['text_Add_Balance']) {
    ...
    if ($datain == "cart_to_offline") {
        ...
        $textcart = "جهت افزایش موجودی و شارژ کیف پول مبلغ $Processing_value تومان به درگاه بانکی کافی بده واریز کنید.
    
    ==================== 
    $PaySetting
    ====================
    
🌅 جهت تکمیل شارژ حساب، لطفا حتمااا یک اسکرین شات از رسید واریز ارسال کنید.🙏🏻";
